...
describe('LuminusUtils', () => {
	describe('isMobile', () => {
		...
		it('should return false for desktop user agent', () => {
			...
			expect(LuminusUtils.isMobile()).toBe(false);
		});
		...
		it('should return true for iPhone user agent', () => {
			...
			expect(LuminusUtils.isMobile()).toBe(true);
		});
	...
	describe('executeFunctionByName', () => {
		it('should execute a simple function', () => {
			...
			const result = LuminusUtils.executeFunctionByName('testFunc', context);
		...
		it('should execute a function with arguments', () => {
			...
			const result = LuminusUtils.executeFunctionByName('add', context, 5, 3);
		...
		it('should execute a nested function', () => {
			...
			const result = LuminusUtils.executeFunctionByName('nested.deepFunc', context);
		...
		it('should execute a deeply nested function', () => {
			...
			const result = LuminusUtils.executeFunctionByName('level1.level2.level3.func', context, 10);
		...
		it('should pass multiple arguments correctly', () => {
			...
			const result = LuminusUtils.executeFunctionByName('multiply', context, 2, 3, 4);
		...
		it('should return null when function name is empty', () => {
			...
			const result = LuminusUtils.executeFunctionByName('', context);
		...
		it('should handle context with this binding', () => {
			...
			const result = LuminusUtils.executeFunctionByName('getValue', context);
		...
		it('should work with array methods', () => {
			...
			const result = LuminusUtils.executeFunctionByName('arr.filter', context, (x: number) => x > 2);
		...
		it('should handle functions that return objects', () => {
			...
			const result = LuminusUtils.executeFunctionByName('getObject', context);
		...
		it('should handle functions that return undefined', () => {
			...
			const result = LuminusUtils.executeFunctionByName('noReturn', context);
