...
describe('NeverquestHealthBar', () => {
	let mockScene: any;
	let healthBar: NeverquestHealthBar;
	...
	describe('Constructor', () => {
		it('should initialize with correct properties', () => {
			healthBar = new NeverquestHealthBar(mockScene, 100, 200, 50, 100);
		...
		it('should set position with custom offsets', () => {
			healthBar = new NeverquestHealthBar(mockScene, 100, 200, 50, 100, 10, 20);
		...
		it('should calculate size as width * 0.43', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 100, 50);

			expect(healthBar.size).toBe(43);
		});

		it('should set initial health equal to max health', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 50, 75);
		...
		it('should call scene.add.existing', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 50, 100);
		...
		it('should set depth to 2', () => {
			const setDepthSpy = jest.spyOn(NeverquestHealthBar.prototype as any, 'setDepth');
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 50, 100);
	...
	describe('Edge Cases', () => {
		it('should handle zero width', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 0, 100);

			expect(healthBar.size).toBe(0);
		});

		it('should handle zero max health', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 50, 0);
		...
		it('should handle very large health values', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 50, 10000);
		...
		it('should handle negative offsets', () => {
			healthBar = new NeverquestHealthBar(mockScene, 100, 100, 50, 100, -10, -20);
		...
		it('should handle very small width values', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 1, 100);
		...
		it('should handle fractional width values', () => {
			healthBar = new NeverquestHealthBar(mockScene, 0, 0, 50.5, 100);
