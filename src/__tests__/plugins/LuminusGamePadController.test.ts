...
import { LuminusGamePadController } from '../../plugins/LuminusGamePadController';
...
describe('LuminusGamePadController', () => {
	let controller: LuminusGamePadController;
	let mockScene: any;
	let mockPlayer: any;
	let mockGamepad: any;
	let mockPhysics: any;
	...
	beforeEach(() => {
		...
		controller = new LuminusGamePadController(mockScene, mockPlayer);
	});
	...
	describe('Constructor', () => {
		...
		it('should create LuminusAnimationManager', () => {
			expect(LuminusAnimationManager).toHaveBeenCalledWith(mockPlayer);
			expect(controller.luminusAnimationManager).toBeDefined();
		});
		...
		it('should initialize luminusBattleManager as null', () => {
			expect(controller.luminusBattleManager).toBeNull();
		});
	});

	describe('create', () => {
		it('should create LuminusBattleManager', () => {
			controller.create();

			expect(LuminusBattleManager).toHaveBeenCalled();
			expect(controller.luminusBattleManager).toBeDefined();
		});
	...
	describe('sendInputs', () => {
		...
		describe('Analog stick', () => {
			it('should animate and move with analog stick input', () => {
				...
				expect(controller.luminusAnimationManager.animateWithAngle).toHaveBeenCalled();
			...
			it('should not use analog stick when x and y are both 0', () => {
				...
				expect(controller.luminusAnimationManager.animateWithAngle).not.toHaveBeenCalled();
