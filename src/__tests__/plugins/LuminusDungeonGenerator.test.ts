/**
 * Tests for LuminusDungeonGenerator plugin
 */
...
describe('LuminusDungeonGenerator', () => {
	let mockScene: any;
	let mockMap: any;
	let mockGroundLayer: any;
	let mockStuffLayer: any;
	let mockTileset: any;
	let dungeonGenerator: LuminusDungeonGenerator;
	...
	describe('Constructor', () => {
		it('should initialize with scene', () => {
			dungeonGenerator = new LuminusDungeonGenerator(mockScene);
