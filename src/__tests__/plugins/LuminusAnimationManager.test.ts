/**
 * Test for LuminusAnimationManager
...
describe('LuminusAnimationManager', () => {
	let mockEntity: any;
	let animationManager: LuminusAnimationManager;
	...
	beforeEach(() => {
		...
		animationManager = new LuminusAnimationManager(mockEntity);
	});
	...
	describe('setIdleAnimation', () => {
		...
		it('should not change animation if entity is attacking', () => {
			...
			const playerAnimManager = new LuminusAnimationManager(mockPlayer);
	...
	describe('isMoving', () => {
		it('should detect movement from container body velocity', () => {
			...
			const manager = new LuminusAnimationManager(mockPlayerWithContainer);
