import { NeverquestVideoOpener } from '../../plugins/NeverquestVideoOpener';

describe('NeverquestVideoOpener', () => {
	let opener: NeverquestVideoOpener;
	let mockScene: any;
	let mockPlayer: any;
	...
	beforeEach(() => {
		...
		opener = new NeverquestVideoOpener(mockScene);
	});
