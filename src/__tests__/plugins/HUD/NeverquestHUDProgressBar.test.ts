...
describe('NeverquestHUDProgressBar', () => {
	let progressBar: NeverquestHUDProgressBar;
	let mockScene: any;
	let mockPlayer: any;
	...
	beforeEach(() => {
		...
		progressBar = new NeverquestHUDProgressBar(mockScene, 10, 20, 80, mockPlayer);
	});
	...
	describe('Constructor', () => {
		...
		it('should attach progressbar to player', () => {
			expect(mockPlayer.neverquestHUDProgressBar).toBe(progressBar);
		});
