/**
 * Tests for LuminusMinimap plugin
 */

import { LuminusMinimap } from '../../../plugins/HUD/LuminusMinimap';

describe('LuminusMinimap', () => {
	let minimap: LuminusMinimap;
	let mockScene: any;
	let mockPlayer: any;
	let mockMap: any;
	...
	describe('Constructor', () => {
		it('should initialize with scene, player, and map', () => {
			minimap = new LuminusMinimap(mockScene, mockPlayer, mockMap);
		...
		it('should call create() during construction', () => {
			const createSpy = jest.spyOn(LuminusMinimap.prototype, 'create');
			minimap = new LuminusMinimap(mockScene, mockPlayer, mockMap);
	...
	describe('renderMap()', () => {
		...
		it('should log render info only once', () => {
			...
			const freshMinimap = new LuminusMinimap(mockScene, mockPlayer, mockMap);
