/**
 * Tests for NeverquestMessageLog plugin
 */

import { NeverquestMessageLog } from '../../../plugins/HUD/NeverquestMessageLog';

describe('NeverquestMessageLog', () => {
	let messageLog: NeverquestMessageLog;
	let mockScene: any;
	...
	beforeEach(() => {
		...
		messageLog = new NeverquestMessageLog(mockScene, 10, 20, 400, 150);
	});
