...
describe('LuminusMapCreator', () => {
	...
	beforeEach(() => {
		...
		mapCreator = new LuminusMapCreator(mockScene, 'testmap');
	});
	...
	describe('constructor', () => {
		...
		it('should use default map name if not provided', () => {
			const defaultMapCreator = new LuminusMapCreator(mockScene);
	...
	describe('create', () => {
		...
		it('should add tileset images', () => {
			...
			mapCreator.tilesetImages.forEach((tilesetImage) => {
