import { LuminusTypingSoundManager } from '../../plugins/LuminusTypingSoundManager';

describe('LuminusTypingSoundManager', () => {
	let manager: LuminusTypingSoundManager;
	let mockScene: any;
	...
	beforeEach(() => {
		...
		manager = new LuminusTypingSoundManager(mockScene);
	});
