...
class TwoFactorAuthTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testKnownTestVectors_sha1() {
        ...
        $secret = 'REDACTED';   //== base32encode('12345678901234567890')
    ...
    public function testKnownTestVectors_sha256() {
        ...
        $secret = 'REDACTED';   //== base32encode('12345678901234567890123456789012')
    ...
    public function testKnownTestVectors_sha512() {
        ...
        $secret = 'REDACTEDREDACTEDREDACTEDGEZDGNA';   //== base32encode('1234567890123456789012345678901234567890123456789012345678901234')
